...
const config = {
  ...
  baseUrl: '/brightwork-functional-spec/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'alexstarbuck', // Usually your GitHub org/user name.
  projectName: 'brightwork-functional-spec', // Usually your repo name.
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Instagram',
                href: 'https://www.instagram.com/zeraxo.agency/',
              },
              {
                label: 'Linkedin',
                href: 'https://hr.linkedin.com/company/zeraxo',
              },
              {
                label: 'Website',
